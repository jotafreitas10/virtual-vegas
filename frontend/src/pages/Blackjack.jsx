...
const Blackjack = () => {
  ...
  return (
    <div>
      ...
      <div>
          <iframe className='max-w-[1240px] p-6 mt-10 mb-10 mx-auto' src="https://free-slots.games/playtechslots/playtech1.php?s=BusterBlackJack/index.html" title="Buster Blackjack - free slot " width="640" height="480" ></iframe>
      </div>
      <Footer />
    </div>
  );
